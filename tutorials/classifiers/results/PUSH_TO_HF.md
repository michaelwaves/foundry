...
for variant in random:results_stop_overfitting clustered:results_cluster_stop_overfit; do
  ...
  hf upload "$repo" "/mnt/nw/home/m.yu/repos/foundry/tutorials/classifiers/$src" \
...
```bash
declare -A ACT=(
  [saeber-rfd3-safeprotein-activations]=/mnt/nw/home/m.yu/repos/foundry/tutorials/sae_data_rfd3_partial/train_activations
  [saeber-rf3-safeprotein-activations]=/mnt/nw/home/m.yu/repos/foundry/tutorials/sae_data_rf3/uniprot/train_activations
)
for name in "${!ACT[@]}"; do
...
mkdir -p "$TMP_RF3_TOX"
ln -snf /mnt/nw/home/m.yu/repos/foundry/tutorials/sae_data_rf3/train_activations "$TMP_RF3_TOX/train_activations"
ln -snf /mnt/nw/home/m.yu/repos/foundry/tutorials/sae_data_rf3/test_activations  "$TMP_RF3_TOX/test_activations"
...
```bash
declare -A SAE=(
  [saeber-rfd3-safeprotein-sae]=/mnt/nw/home/m.yu/repos/foundry/outputs/sae/2026-04-26_15-38-55/train
  [saeber-rf3-toxinpred3-sae]=/mnt/nw/home/m.yu/repos/foundry/outputs/sae/2026-04-26_15-23-45/train
  [saeber-rf3-safeprotein-sae]=/mnt/nw/home/m.yu/repos/foundry/outputs/sae/2026-04-26_22-03-07/train
)
for name in "${!SAE[@]}"; do
...
mkdir -p "$TMP_PROBES"
ln -snf /mnt/nw/home/m.yu/repos/foundry/outputs/classifiers_stop_overfitting   "$TMP_PROBES/random"
ln -snf /mnt/nw/home/m.yu/repos/foundry/outputs/classifiers_cluster_stop_overfit "$TMP_PROBES/cluster"
...
```bash
cat > /mnt/nw/home/m.yu/repos/foundry/tutorials/classifiers/results/register.csv <<'EOF'
