...
> **Addendum (AI4Science retarget):** This copy was forked from the mech-interp version and reframed for the ICML 2026 AI for Science workshop. The technical content (numbers, figures, methods) is unchanged. Differences are confined to:
> - Title: "Auditing an All-Atom Protein Designer: Sparse-Autoencoder Hazard Features in RFdiffusion3" (was "Sparse Autoencoders Find Virulence Features...")
> - Abstract rewritten to lead with autonomous discovery / runtime audit framing.
> - Intro: opens with generative protein design as part of the AI-scientist stack, treats SAEs as a tool, drops the "mechanistic interpretability" lede.
> - Discussion: new paragraph on what this gives an AI-driven design pipeline; the "what the SAE adds" paragraph reworked to emphasise that the sparse representation returns a small named set of directions an audit can act on.
> - Conclusion and Impact Statement reworked for the AI4Science audience (auditability, interpretable safeguards in autonomous loops).
> - Venue footer: `\renewcommand{\Notice@String}{...}` inside `\makeatletter` to print "Submitted to the AI for Science workshop (ICML 2026). Do not distribute."
> - Keywords: protein design, biosecurity, AI for science.
>
> Everything below this addendum is unchanged from the mech-interp version. The "Where I'm unsure" item about the workshop framing is now resolved.

## What I did

Wrote an 8-page workshop submission (6-page main body, 1-2 pages references, 2 pages appendix) titled "Auditing an All-Atom Protein Designer: Sparse-Autoencoder Hazard Features in RFdiffusion3" at `good_copy/example_paper.tex`. Compiles cleanly with `pdflatex + bibtex`. Output PDF at `good_copy/example_paper.pdf`.
